...
{
    ui->setupUi(this);
    uigeotransform = new GeoTransform();
    gcpicpform = new GCP_ICP_collections();
...
void MainWindow::on_actionGCP_ICP_Collection_triggered()
{
    gcpicpform->show();
}

void MainWindow::on_actionGeoSpot_triggered()
{
